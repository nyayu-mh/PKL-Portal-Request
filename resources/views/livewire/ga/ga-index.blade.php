<div>
    <div class="mb-6 flex flex-wrap items-center justify-between gap-3">
        ...
        @if ($canCreate)
            <a href="{{ route('ga.create') }}" class="inline-flex items-center gap-2 rounded-lg bg-gradient-to-r from-indigo-500 to-violet-500 px-4 py-2.5 text-sm font-semibold text-white shadow-lg shadow-indigo-500/25 hover:opacity-90">
