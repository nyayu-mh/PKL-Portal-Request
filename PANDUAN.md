...
- **Riwayat pemantauan untuk atasan**: di menu **Request ERF**/**Request GA** dan di **Dashboard**, Leader/Manager sekarang tetap bisa melihat & memantau progress request yang pernah mereka **setujui/tolak sebagai atasan** — tidak cuma request yang mereka ajukan sendiri. Ada kolom "Peran Anda" di tabel (Pemohon / Atasan (Approval)) supaya jelas bedanya.
